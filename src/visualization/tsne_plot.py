...
class TsnePlot:
    ...
    @staticmethod
    def reduce_clusters(clusters: [[int]]) -> [[int]]:
        """
    ...
    @staticmethod
    def process_vectors(word_vectors):
        """
    ...
    @staticmethod
    def reduce_model(tokens: [[int]], perplexity: int = 5, components: int = 2,
    ...
    def visualize_embeddings_3D(self, embeddings: [[int, int]], labels: [str], plot_title: str, img_title: str, version: int):
        """
        ...
        :param version: digit representing which color scheme to use
        ...
        ax.scatter3D(xs, ys, zs, color=color_schemes[version][0], edgecolors=color_schemes[version][1])
    ...
    def visualize_embeddings_2D(self, embeddings: [[int, int]], labels: [str], plot_title: str, img_title: str, version: int):
        """
        Plots the parameterized data into a visual plot
        ...
        color_schemes = [['#83b975', '#5f9052'], ['#0375fa', '#0256bc']]

        plt.figure(figsize=(16, 9))
        fig, ax = plt.subplots()

        ax.scatter(x, y, alpha=0.4, color=color_schemes[version][0], edgecolors=color_schemes[version][1])
    ...
    @staticmethod
    def similarity_clusters(word_vectors, cluster_keys: [str]) -> ([str], [[int]]):
        """
    ...
    @staticmethod
    def save_title(corpus: str, perplexity: int, components: int, iterations: int, learning_rate: int, extra: str = ''):
        """
        ...
        """
        return corpus + '_tSNE' + str(components) + \
               'D_perplexity' + str(perplexity) + \
